...
const app = {
    ...
    loadCurrentSong: function () {
        ...
        playingNow.innerText = this.currentSong.name;
...
function toggleAudio(action, audioId) {
...
document.addEventListener("click", e => {
    if (e.target.closest(".btn-play")) {
        const id = e.target.closest(".btn-play").dataset.audio;
        toggleAudio("play", id);
    }

    if (e.target.closest(".btn-pause")) {
        const id = e.target.closest(".btn-pause").dataset.audio;
        toggleAudio("pause", id);
    }
});
...
if (!sessionStorage.getItem('popup')) {
    window.addEventListener('load', function () {
        setTimeout(function () {
            ...
            sessionStorage.setItem('popup', 'popup-visible');
